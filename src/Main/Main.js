        ...
        <div className={styles.Main}>
            <div className={`${stylesContainer.Container} ${styles.Container}`}>
                <div className={styles.AboutMe}>
                    ...
                    <h1 className={styles.Name}><span>I am <a style={{color: `${props.PrimeryColor}`}}>Illia Pendlyshak</a> a Frontend developer</span></h1>
                    ...
                    <div className={styles.Button}><button style={{backgroundColor: `${props.PrimeryColor}`}} className={StylesButton.Button}>My Resume</button></div>
                 </div>
